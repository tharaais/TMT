	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
				...
				jQuery.fn.revolution.defaults = {
					...
					stopAfterLoops:4,						// Stop Timer if All slides has been played "x" times. IT will stop at THe slide which is defined via stopAtSlide:x, if set to -1 slide never stop automatic
